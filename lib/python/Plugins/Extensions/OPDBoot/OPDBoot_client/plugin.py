...
pluginpath = "/usr/lib64/enigma2/python/Plugins/"
pluginpath = '/usr/lib64/enigma2/python/Plugins/Extensions/'
pluginpath_extractpy = pluginpath + 'OPDBoot/ubi_reader/ubi_extract_files.py'
pluginpath_extractpyo = pluginpath_extractpy + 'o'
...
OPDBoot_pluginpath = "/usr/lib64/enigma2/python/Plugins/Extensions/OPDBoot"
OPDBoot_client_pluginpath = "/usr/lib64/enigma2/python/Plugins/Extensions/OPDBoot_client"
...
def main(session, **kwargs):
        f = open('/usr/lib64/enigma2/python/Plugins/Extensions/OPDBoot_client/.opdboot_location', 'r')
        mypath = f.readline().strip()
        f.close()
